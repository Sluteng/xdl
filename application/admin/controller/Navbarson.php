...
class Navbarson extends Controller
{
    ...
    {
        if ($this->request->param("navbarson")) {
            $map['navbarson'] = ["like", "%" . $this->request->param("navbarson") . "%"];
        }
    }
    public function add()
    {
        ...
        if ($this->request->isAjax()) {
            ...
            // 添加
                ...
                $arr=i_array_column($navbarsonResult,'state');
                $state=reset($arr);
                // return json($tid);
