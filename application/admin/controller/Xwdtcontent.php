...
class Xwdtcontent extends Controller
{
    ...
    public function add()
    {
        ...
        if ($this->request->isAjax()) {
            ...
            $arr2=i_array_column($xwdtcontentResult,'state');
            $state=reset($arr2);
            $stateResult=$navbarsonModel->where([
                'isdelete'=>0,
                'status'=>1,
                'id'=>$state
            ])->select();
            $arr3=i_array_column($stateResult,'navbarson');
            $navbarson=reset($arr3);
